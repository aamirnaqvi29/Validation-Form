...
export default function App() {
  ...
  const handleSubmit = (e) => {
    ...
    if (isValid) {
      ...
      window.alert("you can check your message in console")
    }
  };
  ...
  return (
    <div className="App min-h-screen flex items-center justify-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-6" style={{border:"2px solid black"}}>
      <div className="bg-gray-800 rounded-lg shadow-lg p-8 max-w-4xl w-full">
        <h1 className="text-2xl font-bold text-center mb-8 text-amber-300">
          Registration Form
        </h1>
